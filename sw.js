...
const CACHE_VERSION = 'v2.7.3'; // Learn tab: swapped hand-drawn line art for commissioned watercolor illustrations (images/learn-*.jpg); terrain-chooser is now 4 real photos in a CSS grid instead of one SVG
